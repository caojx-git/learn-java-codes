    ...
    <div class="left-side">
        <div class="menu-lists">
            <ul>
                ...
                <li>
                    <a href="/fileCollection/collectionPage.do">
                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${requestScope.fileInfoList}" var="fileInfo">
                            <tr>
                                ...
                                <td class="text-left">
                                    <a href="/file/preview.do?fileId=${fileInfo.fileId}">
                                            ${fileInfo.fileName}
                                    </a>
                                </td>
                                ...
                                <td class="text-center">
                                    <a href="/fileCollection/collectionFIle.do?fileId=${fileInfo.fileId}&fileName=${fileInfo.fileName}&uploadId=${fileInfo.userId}&collegeId=${fileInfo.collegeId}">
                                ...
                                <td class="text-center">
                                    <c:choose>
                                        <c:when test="${(sessionScope.userInfo.collegeId == fileInfo.collegeId && sessionScope.userInfo.manager == 1) || sessionScope.userInfo.managerType == 1}">
                                            <a href="/file/removeFile.do?fileId=${fileInfo.fileId}">
