    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="userId" name="userId" readonly="true"
                   value="${requestScope.userInfo1.userId}"
                   placeholder="请输入用户编号">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="userName" name="userName" readonly="true"
                   value="${requestScope.userInfo1.userName}" placeholder="请输入用户姓名">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="password" class="form-control" id="userPassword" name="userPassword"
                   value="${requestScope.userInfo1.userPassword}"
                   placeholder="密码">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="userAge" name="userAge"
                   value="${requestScope.userInfo1.userAge}"
                   placeholder="年龄">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-offset-1">
            <div class="checkbox">
                <label>
                    <c:if test="${requestScope.userInfo1.userGender == 0}">
                        <input type="radio" name="gender" value="0" checked="checked"> 男
                        <input type="radio" name="gender" value="1"> 女
                    </c:if>
                    <c:if test="${requestScope.userInfo1.userGender == 1}">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="userEmail" name="userEmail"
                   value="${requestScope.userInfo1.userEmail}"
                   placeholder="邮箱">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="userAddress" name="userAddress"
                   value="${requestScope.userInfo1.userAddress}"
                   placeholder="住址">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="userPhoneNumber" name="userPhoneNumber"
                   value="${requestScope.userInfo1.userPhoneNumber}"
                   placeholder="手机号">
        </div>
    </div>
    <div class="from-group form-inline">
        ...
        <select class="col-sm-1 form-control" id="collegeId" name="collegeId">
            <c:forEach items="${requestScope.collegeList}" var="collegeInfo">
                <c:choose>
                    <c:when test="${requestScope.userInfo1.collegeId == collegeInfo.codeId}">
        ...
        <select class="col-sm-1 form-control" id="manager" name="manager">
            <c:if test="${requestScope.userInfo1.manager == 1}">
                <option value="0">否</option>
                <option value="1" selected>是</option>
            </c:if>
            <c:if test="${requestScope.userInfo1.manager == 0}">
