...
<div id="main">
  ...
  <div id="header">
    ...
    <div id="mainnav">
      ...
      <span>
							<form action="/SSHRunCommunity/login.do" method="post" id="login">
								<table width="100%">
									<tr>
										<td align="right">
											用户名：
										...
										<td>
											<img src="/SSHRunCommunity/images/authimg.jpg" height:20px; width:60px"/>
										</td>
										<td>
										...
										<td>
											<!-- <a href="/runCommunity/login.do"
												onmouseout="MM_swapImgRestore()"
												onmouseover="MM_swapImage('login','','images/login-24.gif',1)">
												<img src="images/login.gif"
													name="login" border="0" id="login" onclick="javascript:document.login.submit()"/> </a> -->
