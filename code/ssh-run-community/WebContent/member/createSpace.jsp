				...
				<td width="100%">
					<table width="100%" border="0" style="margin: 5px 0;"
		 			...
		 			<tr>
		  			...
		  			<form action="/runCommunity/createSpace.do" method="post"	enctype="multipart/form-data">
					...
					<tr>
						...
						<TD width="50%" align="left">
							<INPUT class=INPUT1 type=text maxLength=14 name="memberspace.opinion"
					...
					<TR>
						...
						<TD width="50%" align="left">
									...
									<input type="radio" name="memberspace.runtime" class=radio1  value="清晨" />清晨
									<input type="radio" name="memberspace.runtime" class=radio1 value="午后" />午后
									<input type="radio" name="memberspace.runtime" class=radio1	value="黄昏" checked="checked"/>黄昏						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
							<FONT color=#ff9933>*</FONT> 喜欢独自跑还是结伴跑？						</TD>
						<TD width="50%" align="left">
							<input type="radio" name="memberspace.runhabit" class=radio1 value="独自" />独自
							<input type="radio" name="memberspace.runhabit" class=radio1 value="结伴" checked="checked"/>结伴
						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
						...
						<TD align="left">
							<INPUT class=INPUT1 type=text maxLength=20 name="memberspace.runstar"	 style="width:200;height:25" />						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
							<FONT color=#ff9933>*</FONT> 正在使用的手机：						</TD>
						<TD width="50%" align="left">
							<INPUT class=INPUT1 type=text maxLength=14 name="memberspace.cellphone" 
																style="width:200;height:25" />						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
						...
						<TD width="50%" align="left">
							<INPUT class="INPUT1" type="text" maxLength="14" name="memberspace.runplace"
