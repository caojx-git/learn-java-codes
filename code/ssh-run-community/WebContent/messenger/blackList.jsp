...
<script type="text/javascript">
		...
		function delBuddy(){
			...
			document.forms.blackListForm.action="<%=basePath%>messenger/delblack.action";
			document.forms.blackListForm.submit();		
		}	
</script>
</head>
...
<div id="main">
  ...
  <ul>
    ...
    <li><a href="listBlack.do" title="黑名单"><span><b>黑名单</b></span></a></li>
  </ul>
</div>
<br /><br />
				...
				<tr>
					<td colspan="2" width="100%">
						<table width="100%">
							...
							<tbody>				
							<s:iterator id="black" value="#request.blacks">			
								<tr>
									<th width="10%" align="center">
										<input type="checkbox" name="nickName" value="<s:property value='#black.nickname'/>" />
									</th>
									<td width="20%" align="center">
										<s:property value="#black.nickname"/>
									</td>
									<td width="20%" align="center">
										<s:if test="#black.gender==0">
											男
										</s:if>
										<s:else>
											女
									...
									<td width="20%" align="center" >
										<s:property value="#black.age"/>
									</td>
									<td width="20%" align="center">
										<s:property value="#black.address"/>
									</td>
									<td width="10%" align="center">
										<img src="../images/button_delete.gif" alt="移动到好友名单" onclick="window.location='addFriend.do?friendname=<s:property value='#black.nickname'/>'" style="cursor:hand"/>
									</td>
								</tr>
							</s:iterator>	
							</tbody>						
