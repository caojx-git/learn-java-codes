	...
	<%request.removeAttribute("message");%>
		...
		<script type="text/javascript">
			...
			function detailMessage(){
				...
				document.forms.inboxForm.action="<%=basePath%>messenger/view.action";
				document.forms.inboxForm.submit();		
			}
		</script>
</head>
...
<div id="main">
  ...
  <ul>
    ...
    <li><a href="/SSHRunCommunity/messenger/listReciverMessage.do" title="收件箱"><span><b>收件箱</b></span></a></li>
    <li><a href="/SSHRunCommunity/messenger/listSendMessage.do" title="发件箱"><span>发件箱</span></a></li>
  </ul>
</div>
<br /><br />
						...
						<table width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td width="20%">
										<s:property value='#message.sender'/>
									</td>
									<td width="30%">
