...
<script src="../js/common.js" type="text/javascript"></script>
		...
		<script type="text/javascript">
			function delMessage(){
				...
				document.forms.outboxForm.action="<%=basePath%>messenger/delSendMessage.action";
...
<div id="main">
  ...
  <ul>
    ...
    <li><a href="/SSHRunCommunity/messenger/listReciverMessage.do" title="收件箱"><span>收件箱</span></a></li>
    <li><a href="/SSHRunCommunity/messenger/listSendMessage.do" title="发件箱"><span><b>发件箱</b></span></a></li>
  </ul>
</div>
<br /><br />
				...
				<tr>
					...
					<td width="100%" colspan="2">
						<table width="100%">
							...
							<tbody>
							<s:iterator id="message" value="#request.messagerecord">
								<tr>
									<td width="10%">
										<input type="checkbox" name="ID" value="<s:property value='#message.id'/>" />
									</td>
									<td width="20%">
										<a href="/SSHRunCommunity/messenger/view.do?ID=<s:property value='#message.id'/>">
											<s:property value="#message.title"/>
										</a>
									</td>
									<td width="20%">
										<s:property value='#message.receiver'/>
									</td>
									<td width="30%">
